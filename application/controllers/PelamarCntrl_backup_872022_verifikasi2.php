...
class PelamarCntrl extends CI_Controller {
	...
	function verifikasi2(){
		...
		if($verif_ijazah1 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatortranskrip = $verifikator_transkrip;
		}else{
			$verifikatorijazah1 = $verifikator_ijazah1;
		}
		...
		if($verif_transkrip1 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatortranskrip1 = $verifikator_transkrip1;
		}else if($verif_transkrip1 == "IPK Kurang dari persyaratan"){
			$verifikatortranskrip1 = $verifikator_transkrip1;
		}else{
			$verifikatortranskrip1 = $verifikator_transkrip1;
		}
		...
		if($verif_akreditasi1 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasi1 = $verifikator_akreditasi1;
		}else if($verif_akreditasi1 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasi1 = $verifikator_akreditasi1;
			$verifikator_akreditasi1saatlulus = $this->input->post("verifikator_akreditasi1saatlulus");
		}else{
			$verifikatorakreditasi1 = $verifikator_akreditasi1;
		...
		if($verif_akreditasiprodi1 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasiprodi1 = $verifikator_akreditasiprodi1;
		}else if($verif_akreditasiprodi1 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasiprodi1 = $verifikator_akreditasiprodi1;
		}else{
			$verifikatorakreditasiprodi1 = $verifikator_akreditasiprodi1;
		}
		...
		if($verif_penyetaraan1 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
		...
		if($verif_ijazah2 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
		...
		if($verif_transkrip2 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatortranskrip2 = $verifikator_transkrip2;
		}else if($verif_transkrip2 == "IPK Kurang dari persyaratan"){
			$verifikatortranskrip2 = $verifikator_transkrip2;
		}else{
			$verifikatortranskrip2 = $verifikator_transkrip2;
		}
		...
		if($verif_akreditasi2 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasi2 = $verifikator_akreditasi2;
		}else if($verif_akreditasi2 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasi2 = $verifikator_akreditasi2;
		}else{
			$verifikatorakreditasi2 = $verifikator_akreditasi2;
		}
		...
		if($verif_akreditasiprodi2 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasiprodi2 = $verifikator_akreditasiprodi2;
		}else if($verif_akreditasiprodi2 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasiprodi2 = $verifikator_akreditasiprodi2;
		}else{
			$verifikatorakreditasiprodi2 = $verifikator_akreditasiprodi2;
		}
		...
		if($verif_penyetaraan2 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
		...
		if($verif_ijazah3 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
		...
		if($verif_transkrip3 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatortranskrip3 = $verifikator_transkrip3;
		}else if($verif_transkrip3 == "IPK Kurang dari persyaratan"){
			$verifikatortranskrip3 = $verifikator_transkrip3;
		}else{
			$verifikatortranskrip3 = $verifikator_transkrip3;
		}
		...
		if($verif_akreditasi3 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasi3 = $verifikator_akreditasi3;
		}else if($verif_akreditasi3 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasi3 = $verifikator_akreditasi3;
		}else{
			$verifikatorakreditasi3 = $verifikator_akreditasi3;
		}
		...
		if($verif_akreditasiprodi3 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			//menggunakan data inputan dari verifikator
			// $verifikatorakreditasiprodi3 = $verifikator_akreditasiprodi3;
		}else if($verif_akreditasiprodi3 == "Tidak sesuai dengan persyaratan"){
			$verifikatorakreditasiprodi3 = $verifikator_akreditasiprodi3;
		}else{
			$verifikatorakreditasiprodi3 = $verifikator_akreditasiprodi3;
		}
		...
		if($verif_penyetaraan3 == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
		...
		if($verif_sertifikat == "Sesuai dengan persyaratan"){
			//menggunakan data inputan dari peserta
			...
			// $verifikatorjenistoefl = $tabelpelamar->jenis_toefl;
			// $verifikatorsertifikat = $verifikator_sertifikat;
		}else if($verif_sertifikat == "Tidak sesuai dengan persyaratan"){
			if(!empty($verifikator_sertifikat)){
				$verifikatorjenistoefl = $verifikator_jenistoefl;
				$verifikatorsertifikat = $verifikator_sertifikat;
			}else{
    ...
    //export peserta
     public function export_peserta() {
         $level = $this->session->userdata('level');
         if ($level=='1'){
            $data['peserta'] = $this->Modelpelamar->get_export_peserta();
