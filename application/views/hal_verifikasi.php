                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
							...
							<?php }?>
							<div class="col-md-16 col-xs-12" style="position: relative; top: -20px;">
								<div class="white-box">
									<div class="user-btm-box">
										<div class="col-md-12">
											<div class="form-group">
												<label for="nama" class="control-label">Dokumen pendukung bagi pelamar :</label>
											</div>
										</div>
                                		<div class="col-md-12">
											<?php
											...
											<div class="col-md-12">
												<div class="form-group">
													<label for="nama" class="control-label">Publikasi :</label>
											...
											<table class="table" id="table-file" border="1">
												<thead>
													<tr>
														<th class="text-center" width="10%">Jenis Publikasi</th>
													...
													<tr>
														...
														<td class="text-center">
															<button type="button" class="fcbtn btn btn-warning btn-1d waves-effect waves-light">
																<a href="<?= base_url('')?><?= $value->path_file?>" id="<?= $value->id_publikasi ?>" target="_blank" style="color:white;">Lihat</a>
															</button>
														<?php
															$level = $this->session->userdata('level');
															if($level == ''){
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="nama" class="control-label">Daftar Riwayat Hidup, Pelatihan dan Pengalaman Kerja :</label>
											</div>
											<table class="table" id="table-file" border="1">
												<thead>
													<tr>
														<th class="text-center" width="1%">No</th>
														<th class="text-center" width="30%">Kategori File</th>
														<th class="text-center" width="30%">File</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														<td class="text-center">
															...
															?>
															<button type="button" class="fcbtn btn btn-warning btn-1d waves-effect waves-light">
																<a href="<?= base_url('')?><?= $drh->path_file?>" target="_blank" style="color:white;">Lihat</a>
															</button>
															<?php
																}else{
															?>
															<button disabled class="fcbtn btn btn-danger btn-1d waves-effect waves-light">Tidak Ada</button>
															<?php
																}
															?>
														</td>
													...
													<tr>
														...
														<td class="text-center">
															...
															?>
															<button type="button" class="fcbtn btn btn-warning btn-1d waves-effect waves-light">
																<a href="<?= base_url('')?><?= $bpl->path_file?>" target="_blank" style="color:white;">Lihat</a>
															</button>
															<?php
																}else{
															?>
													...
													<tr>
														...
														<td class="text-center">
															...
															?>
															<button type="button" class="fcbtn btn btn-warning btn-1d waves-effect waves-light">
																<a href="<?= base_url('')?><?= $bpk->path_file?>" target="_blank" style="color:white;">Lihat</a>
															</button>
															<?php
																}else{
															?>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="nama" class="control-label">Dokumen Administrasi :</label>
											</div>
										</div>
									<form id="ubah-status2">
										<div style="padding-left: 18px;">
											<table class="table" id="table-fileb" border="1">
												<thead>
													<tr>
														<th width="1%" class="text-center">No</th>
														<th width="15%" class="text-center">Kategori File</th>
