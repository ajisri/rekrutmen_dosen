...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <!--<p class="text-muted m-b-30 font-13"> Lengkapi Data Anda dengan Benar.</p>-->
                ...
                <ul class="nav customtab2 nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="">
                    	<a href="#lampiran" aria-controls="Lampiran" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-file"></i></span><span class="hidden-xs"> D. Lampiran (Maksimal masing-masing file 500 kb)</span></a>
                    </li>
                    <li role="presentation" class="">
                    	<a href="#persetujuan" aria-controls="Persetujuan" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-check"></i></span><span class="hidden-xs"> E. Persetujuan</span></a>
                    </li>
                </ul>
                <form id="add-pelamar" class="form-horizontal">
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="formasidanpendidikan">
                            <div class="form-group">
                                <div class="col-md-12">
									...
									<select id="namaFormasi" type="text" class="form-control select2" name="kualifikasi" onChange="namaFormasiHandler()" required>
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<label class="control-label">Tanggal Terbit Sertifikat:</label>
										<div class="">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="lampiran">
							...
							<div class="col-md-12">
								<label>Upload Toefl dan Sertifikat (jadikan dalam satu file jika lebih dari satu sertifikat, bertipe PDF):</label>
								<div class="form-group">
									<div class="col-md-10">
										<div class="fileinput fileinput-new input-group" data-provides="fileinput">
											<div class="form-control" data-trigger="fileinput"> <i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div> <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
        ...
        $('#add-pelamar').submit(function(e){
            ...
            var formData = new FormData($(this)[0]);
                ...
                function (isConfirm) {
                    ...
                    if (isConfirm) {
                        $.ajax({
                            url: '<?= site_url('PelamarCntrl/addDataPelamar') ?>',
                            data:formData,
                            type:'POST',
                            contentType: false,
                            processData: false,
