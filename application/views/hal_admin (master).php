										...
										<form id="add-honor" action="#" method="POST" enctype="multipart/form-data">
											<div class="col-md-3">
												<div class="form-group">
													<label>Akreditasi PT Sarjana</label>
													<select type="text" class="form-control" id="seleksi_akreditasi" name="seleksi_akreditasi" required>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>Akreditasi PS Sarjana</label>
													<select type="text" class="form-control" id="seleksi_akreditasips" name="seleksi_akreditasips" required>
														<option value="A">A</option>
														<option value="A">B</option>
													</select> 
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>IPK Sarjana</label>
													<input type="text" class="form-control" name="seleksi_ipk" />
												</div>
											</div>
									</div>
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
											<label>Akreditasi PT Sarjana Profesi</label>
												<select type="text" class="form-control" id="seleksi_akreditasi1" name="seleksi_akreditasi1" required>
													<option value="A">A</option>
													<option value="A">B</option>
												</select> 
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
											<label>Akreditasi PS Sarjana Profesi</label>
												<select type="text" class="form-control" id="seleksi_akreditasips1" name="seleksi_akreditasips1" required>
													<option value="A">A</option>
													<option value="A">B</option>
												</select> 
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
											<label>IPK Sarjana Profesi</label>
												<input type="text" class="form-control" name="seleksi_ipk1" />
											</div>
										</div>
									</div>
									<div class="row">
											<div class="col-md-3">
												<div class="form-group">
												<label>Akreditasi PT Magister</label>
													<select type="text" class="form-control" id="seleksi_akreditasi2" name="seleksi_akreditasi2" required>
														<option value="A">A</option>
														<option value="A">B</option>
													</select> 
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>Akreditasi PS Magister</label>
													<select type="text" class="form-control" id="seleksi_akreditasips2" name="seleksi_akreditasips2" required>
														<option value="A">A</option>
														<option value="A">B</option>
													</select> 
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>IPK Magister</label>
													<input type="text" class="form-control" name="seleksi_ipk2" />
												</div>
											</div>
									</div>
									<div class="row">
											<div class="col-md-3">
												<div class="form-group">
												<label>Akreditasi PT Doktor</label>
													<select type="text" class="form-control" id="seleksi_akreditasi3" name="seleksi_akreditasi3" required>
														<option value="A">A</option>
														<option value="A">B</option>
													</select> 
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>Akreditasi PS Doktor</label>
													<select type="text" class="form-control" id="seleksi_akreditasips3" name="seleksi_akreditasips3" required>
														<option value="A">A</option>
														<option value="A">B</option>
													</select> 
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
												<label>IPK Doktor</label>
													<input type="text" class="form-control" name="seleksi_ipk3" />
												</div>
											</div>
									</div>
									<div class="row">
											<div class="col-md-3">
												...
												<label>Skor Toefl</label>
													<input type="text" class="form-control" name="seleksi_nilaitoefl" />
												</div>
											</div>
									</div>
